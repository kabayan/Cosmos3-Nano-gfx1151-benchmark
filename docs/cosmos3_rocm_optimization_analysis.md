...
## 2. 当初の課題とボトルネック (v1.0)
初期検証（v1.0）時点では、参照記事（Classmethod、DGX Spark / CUDA 環境）の実測値と比較して非常に低速でした。
*   **T2I**: 974.6秒 (記事値22秒に対し 44.3倍遅い)
*   **T2V**: 483.2秒 (記事値22秒に対し 22.0倍遅い)
*   **Policy**: 約1965秒 (記事値21秒に対し 93.6倍遅い)
